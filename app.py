...
def api_decode():
    ...
    bits.fromfile( request.files['file'] )
    ...
    resp = make_response( all_subsets.to_csv(index=False) )
    resp.headers["Content-Disposition"] = "attachment; filename={0}".format('decoded.csv')
